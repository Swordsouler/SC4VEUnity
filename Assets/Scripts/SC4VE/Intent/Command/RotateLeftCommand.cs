...
namespace Sc4ve.Multimodality.Intent
{
    ...
    [Serializable, CommandDescription("Fait pivoter les objets vers la gauche (axe Y). L'angle en degrés se règle via la propriété « angle » de la commande (45 par défaut ; « de 90 degrés » → \"angle\": \"90\" ; « un peu » → 22.5, « beaucoup » → 90). Paramètres: SelectionParameter.")]
    public class RotateLeftCommand : Command
    {
        ...
        public override List<SemantizationCore> Execute()
        {
            ...
            return ExecuteReversible(objects, obj =>
            {
                ...
                // Signe négatif : la rotation « à gauche » est le sens antihoraire autour de Y monde.
