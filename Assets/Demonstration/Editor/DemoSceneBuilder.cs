...
namespace Sc4ve.Demonstration.EditorTools
{
    ...
    public static class DemoSceneBuilder
    {
                                         ...
                                         string family, string constraint, int index)
        {
            ...
            // 1,43 m et PAS une hauteur « réaliste » choisie seule : c'est la hauteur qui
            // donne au modèle assis LE MÊME FACTEUR D'ÉCHELLE que le serveur debout
            // (1,75 m / 1,09 u ≈ 1,606 ; l'assis fait 0,89 u × 1,606 ≈ 1,43 m). L'invariant
        ...
        /// simulées, pendant que la voix (touche F), Whisper, Piper et les agents tournent
        /// déjà en pur bureau.
        ///
        ...
        private static void BuildExpositionContent(Transform root)
        {
            ...
            (string name, string semantic, Vector3 position, float height)[] actors =
            {
                ...
                ("Client", "sven:Customer", new Vector3(1.4f, 0f, 2.6f), 1.43f),
            };
